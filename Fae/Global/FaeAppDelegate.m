...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if (gDeviceType == DEVICE_IPHONE_35INCH
        || gDeviceType == DEVICE_IPHONE_40INCH)
    {
        gInputTextFont = FONT_LIGHT(17);
        gTermOfServiceNormalFont = FONT_LIGHT(13);
        gTermOfServiceBoldFont = FONT_SEMIBOLD(13);
        gNotifyLblFont = FONT_LIGHT(10);
        gNotifyLblBoldFont = FONT_SEMIBOLD(10);
        gCopyRightFont = FONT_LIGHT(10);
        gButtonFont = FONT_REGULAR(20);
        
        gButton_Height = 36.0f;
    }
    else
    {
        gInputTextFont = FONT_LIGHT(18);
        gTermOfServiceNormalFont = FONT_LIGHT(15);
        gTermOfServiceBoldFont = FONT_SEMIBOLD(15);
        gNotifyLblFont = FONT_LIGHT(11);
        gNotifyLblBoldFont = FONT_SEMIBOLD(11);
        gCopyRightFont = FONT_LIGHT(11);
        gButtonFont = FONT_REGULAR(22);
        
        gButton_Height = 43.0f;
    }
...
- (NSInteger)countOfProblemAccounts
{
    return 5;
}
