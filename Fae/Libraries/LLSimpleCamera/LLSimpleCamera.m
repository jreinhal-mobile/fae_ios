...
- (void)viewDidLoad
{
    ...
    UIView *focusView = [[UIView alloc] initWithFrame:self.preview.frame];
    focusView.backgroundColor = [UIColor clearColor];
    [focusView.layer addSublayer:self.focusBox];
    [focusView.layer addSublayer:self.focusInnerBox];
...
- (CALayer *) focusBox
{
    if ( !_focusBox ) {
        ...
        [_focusBox setCornerRadius:25.0f];
        [_focusBox setBounds:CGRectMake(0.0f, 0.0f, 50, 50)];
        [_focusBox setBorderWidth:2.f];
...
- (CALayer *) focusInnerBox
{
    if ( !_focusInnerBox ) {
        _focusInnerBox = [[CALayer alloc] init];
        [_focusInnerBox setCornerRadius:23.f];
        [_focusInnerBox setBounds:CGRectMake(0.0f, 0.0f, 46, 46)];
        [_focusInnerBox setBackgroundColor:[RGBColor(0xffffff, 1) CGColor]];
        [_focusInnerBox setOpacity:0];
    }
    
    return _focusInnerBox;
}

- (void) drawFocusBoxAtPointOfInterest:(CGPoint)point andRemove:(BOOL)remove
{
    [self draw:self.focusBox innerLayer:self.focusInnerBox atPointOfInterest:point andRemove:remove];
}

- (void) draw:(CALayer *)layer innerLayer:(CALayer *)innerLayer atPointOfInterest:(CGPoint)point andRemove:(BOOL)remove
{
    if ( remove )
    ...
    if ( [layer animationForKey:@"transform.scale"] == nil && [layer animationForKey:@"opacity"] == nil )
    {
        ...
        [innerLayer setPosition:point];
        [CATransaction commit];
        
        CAKeyframeAnimation *scale = [CAKeyframeAnimation animationWithKeyPath:@"transform.scale"];
        [scale setValues:@[@1, @1.2, @1.2, @1]];
        [scale setKeyTimes:@[@0, @0.35, @0.6, @0.9]];
        [scale setDuration:0.9];
        [scale setRemovedOnCompletion:YES];
        
        CAKeyframeAnimation *opacity = [CAKeyframeAnimation animationWithKeyPath:@"opacity"];
        [opacity setValues:@[@0, @0.8, @1, @1]];
        [opacity setKeyTimes:@[@0, @0.35, @0.6, @1.1]];
        [opacity setDuration:1.1];
        ...
        CAKeyframeAnimation *scaleInner = [CAKeyframeAnimation animationWithKeyPath:@"transform.scale"];
        [scaleInner setValues:@[@0.2, @0.8, @1.1, @1.1]];
        [scaleInner setKeyTimes:@[@0, @0.35, @0.5, @0.6]];
        [scaleInner setDuration:0.6];
        [scaleInner setRemovedOnCompletion:YES];
        
        CAKeyframeAnimation *opacityInner = [CAKeyframeAnimation animationWithKeyPath:@"opacity"];
        [opacityInner setValues:@[@0, @1, @1, @0]];
        [opacityInner setKeyTimes:@[@0, @0.65, @.75, @0.8]];
        [opacityInner setDuration:0.8];
        [opacityInner setRemovedOnCompletion:YES];
        
        [innerLayer addAnimation:scaleInner forKey:@"transform.scale"];
        [innerLayer addAnimation:opacityInner forKey:@"opacity"];
...
- (void)setFocusOnSelectedPoint:(CGPoint)pointFromSuperView
{
    // focus
    CGPoint pointOfInterest = [self convertToPointOfInterestFromViewCoordinates:pointFromSuperView];
    [self focusAtPoint:pointOfInterest];
    
    // show the box
//    [self showFocusBox:pointFromSuperView];
    
    [self drawFocusBoxAtPointOfInterest:pointFromSuperView andRemove:YES];
}
...
- (NSArray *)gestureRecognizers {
    return self.preview.gestureRecognizers;
}
