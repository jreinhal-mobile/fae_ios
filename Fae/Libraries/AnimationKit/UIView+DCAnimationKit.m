...
-(void)bounce_Left:(DCAnimationFinished)finished
{
    
}

-(void)bounce_Right:(DCAnimationFinished)finished
{
...
-(void)bounce_Left:(CGFloat)offset finished:(DCAnimationFinished)finished
{
    UIDynamicAnimator *animator = [self dc_animator];
    [animator removeAllBehaviors];
    [self moveX:offset duration:0.25 finished:^{
        [self moveX:-offset duration:0.15 finished:^{
            [self moveX:(offset/2) duration:0.15 finished:^{
                [self moveX:-(offset/2) duration:0.05 finished:^{
                    if(finished)
                        finished();
                }];
            }];
...
-(void)bounce_Right:(CGFloat)offset finished:(DCAnimationFinished)finished
{
    UIDynamicAnimator *animator = [self dc_animator];
    [animator removeAllBehaviors];
    [self moveX:-offset duration:0.25 finished:^{
