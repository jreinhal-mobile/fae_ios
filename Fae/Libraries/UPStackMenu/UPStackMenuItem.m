...
- (id)initWithImage:(UIImage*)image
           fillSize:(CGSize)frameSize
{
    return [self initWithImage:image fillSize:frameSize highlightedImage:Nil title:Nil];
}
...
{
    return [self initWithImage:image fillSize:frameSize highlightedImage:highlightedImage title:title font:Nil];
}
               ...
               font:(UIFont*)font
{
    ...
    if(self) {
        ...
        [_imageButton setFrame:CGRectMake(0, 0, frameSize.width-10, frameSize.height-10)];
