...
@interface FaeProblemPasswordVC ()

@end

@implementation FaeProblemPasswordVC
...
- (void)initUI
{
    if (gDeviceType == DEVICE_IPHONE_35INCH)
    {
        ...
        img_cat_topPadding.constant = 30.0f;
        panel_topPadding.constant = -5.0f;
        
        line_pass_topPadding.constant = 40.0f;
        line_conf_topPadding.constant = 95.0f;
        ...
        btnJoinTopPadding.constant = 35.0f;
    ...
    else if (gDeviceType == DEVICE_IPHONE_40INCH)
    {
        ...
        img_cat_topPadding.constant = 80.0f;
        panel_topPadding.constant = 20.0f;
    ...
    else if (gDeviceType == DEVICE_IPHONE_47INCH)
    {
        ...
        img_cat_topPadding.constant = 100.0f;
        panel_topPadding.constant = 10.0f;
        
        line_pass_topPadding.constant = 56.0f;
        line_conf_topPadding.constant = 142.0f;
        ...
        btnJoinTopPadding.constant = 60.0f;
    ...
    else if (gDeviceType == DEVICE_IPHONE_55INCH)
    {
        ...
        img_cat_topPadding.constant = 70.0f;
        panel_topPadding.constant = 40.0f;
        
        line_pass_topPadding.constant = 64.0f;
        line_conf_topPadding.constant = 150.0f;
